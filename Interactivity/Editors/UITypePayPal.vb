        ...
        Public Overrides Function EditValue(ByVal context As ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            ...
            If (Not context Is Nothing And Not context.Instance Is Nothing And Not provider Is Nothing) Then
                ...
                If (Not service Is Nothing) Then
                    ...
                    Dim script As DataType.LocalizableString = openElement.Serialization.Clone(value)

                    Dim frmPayPal As New openElement.WebElement.ElementWECommon.Interactivity.Forms.FrmPayPal(script, Utils.GetPageCultureContext(context))
                    If service.ShowDialog(frmPayPal) = DialogResult.OK Then
