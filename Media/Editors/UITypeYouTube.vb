        ...
        Public Overrides Function EditValue(ByVal context As ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            If (Not context Is Nothing And Not context.Instance Is Nothing And Not provider Is Nothing) Then
                ...
                If (Not _Service Is Nothing) Then
                    ...
                    Dim youTubeObject As LocalizableString = Serialization.Clone(value)

                    Dim frmYouTube As New FrmYouTube(youTubeObject, Utils.GetPageCultureContext(context))
                    If _Service.ShowDialog(frmYouTube) = DialogResult.OK Then
